...
public class PedinaGUI extends JPanel {
    ...
    private Casella parent;
    private String text;

    
    public PedinaGUI(int id, Casella parent, int x, int y, int w, int h) {
        this.id = id;
        this.parent = parent;
        setBounds(x, y, w, h);
    ...
    public PedinaGUI(int id, Casella parent, String text, int x, int y, int w, int h) {
        this.id = id;
        this.parent = parent;
        this.text = text;
    ...
    public void setParent(Casella parent) {
        this.parent = parent;
    }
